...
int TeaOrMe(int j,int storeNum, int centerNum, int cost, bool *storeSet, bool *centerSet, int **profitTable, int **storeInfo, int **centerInfo, int transInfoA[4]);
//for functionA
...
int main(){
    ...
    while(true){
    	...
    	int profitAA = 0;
    	while(profitAA >= 0){
    		int profitAA = TeaOrMe(transInfoA[0],storeNum,centerNum,cost,storeSet,centerSet,profitTable,storeInfo,centerInfo,transInfoA);
    		if (profitAA > 0){
    		    profit+=profitAA;
    		    set(centerSet,storeSet,setTable,storeInfo,centerInfo,transInfoA);
    		}
